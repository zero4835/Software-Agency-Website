...
export const WorkLeft: React.FC<ProgressProps> = ({ children, progress }) => {
  ...
  return (
    <div
      className="flex flex-col items-center justify-center text-3xl lg:text-3xl lg:h-auto"
      style={{
...
export const WorkRight: React.FC<ProgressProps> = ({ children, progress }) => {
